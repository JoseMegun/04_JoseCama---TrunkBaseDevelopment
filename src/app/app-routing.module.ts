...
import { PaymentDetailListComponent } from './users/PagoDetalle/payment-detail-list/payment-detail-list.component';
import { PaymentDetailFormComponent } from './users/PagoDetalle/payment-detail-form/payment-detail-form.component';
import { PaymentDetailEditComponent } from './users/PagoDetalle/payment-detail-edit/payment-detail-edit.component';
...
const routes: Routes = [
  ...
  {
    path: 'paymentDetail/registro',
    component: PaymentDetailFormComponent,
  },
  {
    path: 'paymentDetail/editar/:id',
